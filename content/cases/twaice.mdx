...
<Mockup alt="e-mobility battery health widget" />
...
<Mockup alt="Energy Health dashboard with quick links to other modules" />
...
<Mockup alt="Energy new architecture — unified navigation across modules" />

<Mockup alt="Infographic showing navigation possibilities across modules" />

<Mockup alt="Energy asset dashboard — portfolio overview" />
...
<Mockup alt="Performance Manager v1 — performance dashboard, balance analysis, temperature analysis" />

<Mockup alt="Performance Manager v2 — portfolio overview with items to resolve" />

<Mockup alt="Performance Manager v3 — impact overview, availability analysis, imbalance analysis" />
...
<Mockup alt="Safety monitoring — design system consistency applied across modules" />
...
<Mockup alt="Energy Health and Performance Manager — final shipped state" />
