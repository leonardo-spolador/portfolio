...
<Accordion chapter="1" title="Energy Health: Making battery data actionable" subtitle="48% increase in annual contract value for energy products.||€1.6M in additional revenue per 10MWh for clients like VERBUND.">
...
<Carousel srcs="/cases/twaice/unified-navigation.jpg,/cases/twaice/unified-architecture.png,/cases/twaice/trends-indepth.jpg,/cases/twaice/asset-portfolio-overview.jpg" alts="Unified navigation — the Asset Dashboard connecting every module||Energy new architecture — unified navigation across modules||Infographic showing navigation possibilities across modules||Energy asset dashboard — portfolio overview" />
...
<Carousel srcs="/cases/twaice/performance-manager-1.jpg,/cases/twaice/performance-manager-2.jpg,/cases/twaice/performance-manager-3.jpg" alts="Performance Manager v1 — performance dashboard, balance analysis, temperature analysis||Performance Manager v2 — portfolio overview with items to resolve||Performance Manager v3 — impact overview, availability analysis, imbalance analysis" />
