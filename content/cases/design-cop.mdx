...
<Carousel showCaption={false} slides={Array.from({ length: 15 }, (_, i) => ({ src: `/cases/design-cop/slides/slide-${String(i + 1).padStart(2, "0")}.jpg`, alt: `UX + Agile training deck — slide ${i + 1} of 15` }))} />
